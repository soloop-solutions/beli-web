  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4">
      {posts.map((post) => (
        ...
        >
          {/* Image Section */}
          <div className="relative w-full aspect-video overflow-hidden transform translate-y-0 group hover:translate-y-[-10px] transition-transform duration-300 ease-in-out">
            <img
              src={post.image}
              alt={post.title}
          ...
          <div className="p-3 sm:p-4">
            ...
            <p className=" flex justify-content-start text-xs sm:text-sm text-gray-200 mb-2">
              {post.date}
            </p>
