...
const PlaneSection: React.FC = () => {
  ...
  const message = intl.formatMessage({
    id: "plane.planeSection.whatsappMessage",
  });

  return (
    <div
      className="bg-[#1C79B8] relative w-full px-4 py-8 sm:px-6 sm:py-6"
      id="plane"
    >
          ...
          <div className="order-1 lg:order-1 w-full md:w-3/4 flex justify-center">
            <div className="relative w-full max-w-2xl rounded-lg shadow-lg overflow-hidden">
              ...
              <img
                ...
                className="w-full h-auto rounded-lg border-2 border-white transition-transform duration-300 transform hover:scale-105"
              />
            </div>
          </div>
        </div>
