  ...
  return (
    <footer className="flex bg-[#1E57A8] text-white sm:py-6">
      <div className="container mx-auto px-5">
        <div className="flex flex-col lg:flex-row items-start space-y-8 lg:space-y-0 lg:space-x-32 w-full justify-between px-5">
          ...
          <div className="flex flex-col items-start lg:items-start">
            ...
            <div className="space-y-4 text-gray-200 text-sm">
              ...
              <p className="flex items-center">
                ...
                <a className="text-gray-200" href="mailto:info@altairtheme.com">
          ...
          {/* Google Map Section */}
          <div className="flex flex-col items-start lg:items-start w-full lg:w-[30%]">
            ...
            <iframe
              ...
              className="w-full h-[50px] sm:h-[150px]"
              loading="lazy"
              title="Google Map"
            ></iframe>
          </div>
        ...
        {/* Footer Bottom */}
        <div className="mt-6 border-t border-gray-300 text-center text-sm text-gray-200 pt-2">
